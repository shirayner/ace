...
**退出条件**：所有 status=open 的问题都已 resolved。此时需求基本确定，AI 可以形成完整理解。
...
**关键假设**
- 假设 1（来自 issues 文档中 status=assumed 的条目）
- 假设 2
...
**注意**：此时展示的是**确定性认知**，不是"一堆假设"。如果仍有 ⚠️ 不确定项，说明 Step B 澄清不充分，应回到 Step 9 继续循环。
